...
<body class="bg-white w-full">
   ...
   <div class="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
    ...
    <!-- Event List (not connected to calendar) -->
    <div class="w-full max-w-5xl mx-auto mt-8 mb-8">
        <h2 class="text-xl font-bold mb-4 text-indigo-700">All Scheduled Events</h2>
        <div class="space-y-4">
        <?php
        ...
        if ($eventListResult && $eventListResult->num_rows > 0):
            while ($row = $eventListResult->fetch_assoc()): ?>
                <div class="bg-white border border-gray-200 rounded-lg shadow p-4 hover:shadow-lg transition">
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-2">
                        <div class="text-lg font-semibold text-indigo-700"><?php echo htmlspecialchars($row['event_name']); ?></div>
                    ...
                    <div class="text-sm text-gray-700 mb-1"><span class="font-medium">Location:</span> <?php echo htmlspecialchars($row['location']); ?></div>
                    <div class="text-sm text-gray-700"><span class="font-medium">Description:</span> <?php echo nl2br(htmlspecialchars($row['description'])); ?></div>
                </div>
            <?php endwhile;
        else: ?>
