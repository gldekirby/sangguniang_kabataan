                    ...
                    if ($result && $result->num_rows > 0) {
                        while ($member = $result->fetch_assoc()) {
                            ...
                            if (preg_match('/^\+639\d{9}$/', $formatted_number)) {
                                ...
                                $messageText = "Hi $firstname! 📅 You're invited to the event: \"$event_name\" on $start_date to $end_date at $start_time_formatted - $end_time_formatted in $location.\n\nEvent Details:\n$description\n\nSee you there!";
                ...
                if ($result && $result->num_rows > 0) {
                    while ($member = $result->fetch_assoc()) {
                        ...
                        if (preg_match('/^\\+639\\d{9}$/', $formatted_number)) {
                            ...
                            $start_time_formatted = date('g:i A', strtotime($start_time));
                            $end_time_formatted = date('g:i A', strtotime($end_time));
                            $messageText = "Hi $firstname! 📅 The event \"$event_name\" has been updated. It will now take place from $start_date to $end_date at $start_time_formatted - $end_time_formatted in $location.\n\nUpdated Details:\n$description\n\nThank you!";
                            $message = new Message($messageText, [$formatted_number]);
                            try {
                                $client->Send($message);
