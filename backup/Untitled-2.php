...
<body class="bg-white w-full">
   ...
   <div class="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
    ...
    <div class="container-fluid p-0">
        ...
        <button id="addEventBtn" type="button" onclick="openModal()" class="fixed bottom-8 right-8 z-50 bg-indigo-600 hover:bg-indigo-700 text-white rounded-full shadow-lg p-4 text-2xl focus:outline-none focus:ring-2 focus:ring-indigo-400">
            +
        </button>
    </div>
