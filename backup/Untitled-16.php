       ...
       <div class="mx-auto w-full overflow-x-auto">
        ...
        <table class="w-full mx-auto text-sm">
         ...
         <tbody>
          ...
          fetch_assoc()): ?>
          <tr class="hover:bg-blue-50 transition-colors" data-fiscal-year="<?= date('Y', strtotime($row['fiscal_year'])) ?>" data-fiscal-month="<?= date('m', strtotime($row['fiscal_year'])) ?>" data-program-name="<?= htmlspecialchars(strtolower($row['program_name'])) ?>">
        ...
        <i class="fas fa-trash-alt fa-lg"></i>
          ...
          <tr class="bg-gray-100 font-semibold text-gray-800 hidden">
           ...
           <td class="text-green-700 text-right">
            ₱
            <?= number_format($total_allocated, 0) ?>
           </td>
           <td colspan="2">
           </td>
          </tr>
