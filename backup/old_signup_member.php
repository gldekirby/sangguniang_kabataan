...
<html class="scroll-smooth" lang="en">
 ...
 <body class="bg-gray-50 min-h-screen flex items-center justify-center py-6 px-4 relative">
  ...
  <div class="flex justify-center mb-2">
   ...
   <?php if ($success): ?>
   <meta content="3;url=login.php" http-equiv="refresh"/>
   <script>
    document.addEventListener('DOMContentLoaded', function() {
        showToast('success', '🎉 Registration Successful! Thank you for joining SK Youth. Redirecting to login page in 3 seconds...');
    });
   </script>
   ...
   <form class="space-y-8" enctype="multipart/form-data" method="POST" novalidate>
    <section>
     ...
     <div class="space-y-3 mt-3">
      ...
      <select class="w-full border border-gray-300 rounded-md px-2 py-1.5 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm" name="street" required>
      ...
      <select class="w-full border border-gray-300 rounded-md px-2 py-1.5 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm" name="barangay" required>
       <option value="">Select Barangay</option>
       <option value="Poblacion">Poblacion</option>
      </select>

      <select class="w-full border border-gray-300 rounded-md px-2 py-1.5 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm" name="city" required>
       <option value="">Select City/Municipality</option>
       <option value="Tupi">Tupi</option>
      </select>

      <select class="w-full border border-gray-300 rounded-md px-2 py-1.5 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm" name="province" required>
    ...
    <section>
     ...
     <div class="mt-3">
      ...
      <input autocomplete="off" class="w-full border border-gray-300 rounded-md px-2 py-1.5 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm" id="year_level" name="year_level" type="text"/>
     </div>
    </section>
    <section>
