<?php
require 'C:/xampp/htdocs/sangguniang_kabataan/sms/vendor/autoload.php';
...
<html class="scroll-smooth" lang="en">
 <head>
  ...
  <style>
    ...
    .admin-status-page main {
      flex-grow: 1;
      max-width: 100%;
      background-color: #f9fafb;
    }
    .admin-status-page .modal-content::-webkit-scrollbar {
      width: 8px;
    }
    .admin-status-page .modal-content::-webkit-scrollbar-thumb {
      background-color: rgba(107, 114, 128, 0.5);
      border-radius: 4px;
    }
    .admin-status-page ul {
      padding-left: 1.25rem;
      margin: 0;
      list-style-type: disc;
    }
    .admin-status-page fieldset {
      border: 1px solid #d1d5db;
      border-radius: 0.375rem;
      padding: 1rem 1.5rem 1.5rem 1.5rem;
      margin-bottom: 1.5rem;
    }
    .admin-status-page legend {
      font-weight: 600;
      font-size: 1.125rem;
      color: #1e40af;
      padding: 0 0.5rem;
    ...
    .admin-status-page .fieldset-row {
      display: flex;
      flex-wrap: wrap;
      gap: 1.5rem;
      margin-top: 0.75rem;
    }
    .admin-status-page .fieldset-item {
      flex: 1 1 45%;
      min-width: 200px;
    }
    .admin-status-page .fieldset-item strong {
      display: inline-flex;
      align-items: center;
      gap: 0.25rem;
      color: #6b7280;
    }
    .admin-status-page .fieldset-item span {
      margin-left: 0.25rem;
      color: #374151;
    ...
    .admin-status-page .image-overlay {
      position: fixed;
      top: 0;
      left: 0;
      width: 100vw;
    ...
    .admin-status-page .image-overlay-content {
      position: relative;
      max-width: 90vw;
      max-height: 90vh;
      display: flex;
    ...
    .admin-status-page .image-overlay-content img {
      max-width: 50%;
      max-height: 50%;
      border-radius: 12px;
      box-shadow: 0 0 20px rgba(0, 0, 0, 0.5);
    }
    .admin-status-page #imageOverlayClose {
      position: absolute;
      top: -10px;
      right: -10px;
      background: #ef4444;
    ...
    .admin-status-page #imageOverlayClose:hover {
      background: #b91c1c;
    }
  </style>
 </head>
 <body class="bg-gray-50 min-h-screen flex flex-col font-inter">
  <div class="admin-status-page"><!-- ADDED WRAPPER -->
